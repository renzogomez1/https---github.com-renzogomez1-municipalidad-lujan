...
<html lang="es">
    ...
    <body class="bg-gray-50">
        ...
        <div class="mobile-menu hidden 
            ...
            <ul class="flex flex-col items-center text-center space-y-6 text-gray-700 text-lg w-full">
                ...
                <li class="opacity-0" style="animation-delay: 0.10s;"><a href="#" class="menu-item">Volver al Inicio</a></li>
                <li class="opacity-0" style="animation-delay: 0.16s;"><a href="#" class="menu-item">Eventos</a></li>
                <li class="opacity-0" style="animation-delay: 0.22s;"><a href="#" class="menu-item">Agenda</a></li>
                <li class="opacity-0" style="animation-delay: 0.28s;"><a href="#" class="menu-item">Alojamientos</a></li>
                <li class="opacity-0" style="animation-delay: 0.34s;"><a href="#" class="menu-item">Gastronomía</a></li>
                <li class="opacity-0" style="animation-delay: 0.40s;"><a href="#" class="menu-item">Transporte</a></li>
                <li class="opacity-0" style="animation-delay: 0.46s;"><a href="#" class="menu-item">Emergencias</a></li>
                <li class="opacity-0" style="animation-delay: 0.52s;"><a href="#" class="menu-item">Fotos</a></li>
    ...
    <div class="flex pt-[60px] px-5 md:px-10 lg:px-8 xl:px-10 gap-10">
        ...
        <aside class="w-[280px] flex-shrink-0 
            ...
            <!-- Botones con el MISMO estilo que Cerrar Sesión -->
            <button class="panel-btn bg-white text-gray-700 
                            text-sm hover:bg-orange-100 active:scale-95 transition 
                            w-full h-11 rounded-lg text-left px-4"
                    data-page="inicio">
                Volver al Inicio
            </button>
